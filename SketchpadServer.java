...
public class SketchpadServer extends JFrame implements ActionListener, ItemListener{
	...
	Socket sock;OutputStream ostream; 
	InputStream istream;ObjectInputStream ois;ObjectOutputStream oos;Object obj;
	GridBagConstraints gbc2;
	
	public static void main(String[] args) throws Exception {
		SketchpadServer spc = new SketchpadServer("SERVER PAINT");
	}
	...
	public SketchpadServer(String s) throws Exception {
		...
		//JTabbedPane - "Home" Tab: colorpan/shapepan/checkpan(used GridBagLayout) 
	...
	//set connection server-client
	public void connected() throws Exception{
		sersock = new ServerSocket(9802);
		sock = sersock.accept();
		System.out.println("This is Server. Starting connection.");
...
//		실패한 부분: client에서 server으로 전송한 정보 받는 부분
//		while(true){
//			try {
...
//			drObj.add(a);
//			System.out.println("drawingobject added");
//			canvas.repaint();
//			if(check==true)
//				break;
//		}catch(Exception e){
...
//		}}
	...
	class CenterJPanel extends JPanel {
		CenterJPanel() {
			...
			this.addMouseListener(new MouseAdapter() {
				...
				public void mouseReleased(MouseEvent event)
				{
					...
					//Plus send DrawingObject to Client when mouse released
					try {
		...
		//repaint function: paint Server DrawingObject
	...
	private void initializeTabbedPaneButtons() {
		...
		checkpan.add(checklab,gbc2);
		checkpan.add(fill,gbc2);
		fill.addItemListener(this);
		checkpan.add(outline,gbc2);
